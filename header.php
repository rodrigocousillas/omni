...
<header class="container <?php if($seccion=='Inicio') { echo 'darkNav'; }; if ($seccion=='Productos') { echo 'darkNav'; } else { echo 'lightNav'; } ?>">
...
<nav class="navbar navbar-expand-lg navbar-light animated fadeInDown">
  <a class="navbar-brand" href="index.php"><img src="img/omni.png" alt=""></a>

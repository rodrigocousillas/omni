      ...
      <div id="page-wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
              <li class="active"><i class="fa fa-bullhorn"></i> Herrajes</li>
            </ol>
          </div>
        </div><!-- /.row -->

        <button type="button" class="btn btn-success" onclick="location.href = 'abm_herrajes.php?action=2'"> Agregar </button> <br><br>

        <?php
              $query="SELECT h.*, c.nombre as categoria FROM " . TABLA_HERRAJES . " h 
                        INNER JOIN ".TABLA_CATEGORIAS." c ON h.id_categoria = c.id  
                      ORDER BY h.id DESC";
              ...
              <table class="table table-hover tablesorter">
                ...
                <tbody>
                  ...
                  <tr>                    
                    ...
                    <?php if($imagen != "") { ?>
                      <td> <a href="../img/herrajes/<?php echo $imagen; ?>" target="blank"><i class="fa fa-camera"></a></td>
                    <?php } else { ?>
                      <td> </td>
                    <?php } ?>
                    
                    <td> <button type="button" class="btn btn-primary" onclick="location.href = 'abm_herrajes.php?action=3&id=<?php echo $r['id'] ?>'"> Modificar </button> </td>
                    <td> <button type="button" class="btn btn-danger" onclick="location.href = 'eliminar_herrajes.php?id=<?php echo $r['id'] ?>'"> Eliminar </button> </td>
                  </tr>
                  <?php } ?>
                </tbody>
              </table>

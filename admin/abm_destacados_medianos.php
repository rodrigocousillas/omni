...
if($action == 3) {
  ...
  if (!$result) {
    echo '<div class="alert alert-danger" role="alert">No se ha encontrado ningun elemento. Haga <a href="listar_destacados_medianos.php" class="alert-link">click aquí</a> para volver</div>';
...
?>
      ...
      <div id="page-wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
              <li><a href="listar_destacados_medianos.php"><i class="fa fa-bullhorn"></i> Listar destacados Medianos </a></li>
              <li class="active">ABM Modelos Medianos Home Productos</li>
            </ol>
          </div>
        </div><!-- /.row -->
    ...
    if(isset($_POST['btn_agregar']) && $action == 2){
        ...
        $query_agregar = mysqli_query($conexion,"INSERT INTO " . TABLA_MODELOS_MEDIANOS . " SET 
          modelo='$modelo',
          marca='$marca',
          imagen='$imagen',
          imagen2='$imagen2',
        ...
        if (!$query_agregar) {
          echo '<div class="alert alert-danger" role="alert">Se ha producido un error. Intentenlo más tarde. Haga <a href="listar_destacados_medianos.php" class="alert-link">click aquí</a> para volver</div>';
          echo mysqli_error($conexion);
        die();
          ...
          echo '<div class="alert alert-success" role="alert">El item ha sido agregado con éxito. Haga <a href="listar_destacados_medianos.php" class="alert-link">click aquí</a> para volver</div>';  
          die();
        }
}
    ...
    if(isset($_POST['btn_agregar']) && $action == 3){
      ...
      $query="UPDATE " . TABLA_MODELOS_MEDIANOS . "  SET  
          modelo='$modelo',
          marca='$marca',
          orden='$orden',
      ...
      die();
        ...
        echo '<div class="alert alert-success" role="alert">El item ha sido modificado con éxito. Haga <a href="listar_destacados_medianos.php" class="alert-link">click aquí</a> para volver</div>';  
        die();
      }
    ...
    <!-- Agrego -->
        <div class="row">
          <div class="col-lg-12">
            ...
            <form role="form" enctype="multipart/form-data" method="post" action="abm_destacados_medianos.php?action=<?php echo $action;?><?php if($action==3) { echo "&id=".$id; } ?>">

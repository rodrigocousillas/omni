...
<div class="container" >
	<section class="center slider">
		<div>
		 ...
		 <?php if(!empty($imagen7)) { ?>
		<div>
			<img src="img/productos/<?php echo $imagen7 ?>" alt="" class="d-block mx-auto" width="100%">
		</div>
	<?php } ?>
	 <?php if(!empty($imagen8)) {?>
		<div>
			<img src="img/productos/<?php echo $imagen8 ?>" alt="" class="d-block mx-auto" width="100%">
		</div>
	<?php } ?>
	</section>
...
<div class="container-fluid mobile">
	...
	<div class="row" style="background-color: #141823;">
		<div class="col-12" >
		<section id="parallax"  >
			<div class="col-12 wow fadeInUp" data-wow-delay="0.2s" style="animation-duration: 2s;" >
				<h3>
					<?php echo $titulo_para; ?>
				</h3>
				<div style="padding-bottom: 75px;">
...
<div class="container-fluid contactarProductos">
	<div class="row sinpadding">
		...
		<div class="col-12 col-md-5 texto">
			...
			<a href="https://www.omnisrl.com.ar/contacto.html" class="btn btn-contactarAsesor">CONTACTAR ASESOR <i class="fas fa-plus" ></i></a>
